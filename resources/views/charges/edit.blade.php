        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input datepicker datepicker-format="yyyy-mm-dd" type="text" name="date" id="date" required value="{{ old('date', $charge->date->format('Y-m-d')) }}" placeholder="Select date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5">
                </div>
                @error('date')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" min="0" name="amount_charged" id="amount_charged" required value="{{ old('amount_charged', $charge->amount_charged) }}" class="block w-full pl-7 pr-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="0.00">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" min="0" name="net" id="net" required value="{{ old('net', $charge->net) }}" class="block w-full pl-7 pr-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="0.00">
                </div>
                @error('net')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" step="0.01" min="0" max="100" name="commission_percentage" id="commission_percentage" value="{{ old('commission_percentage', $charge->commission_percentage) }}" class="block w-full px-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="0.00">
            ...
            <div>
                ...
                <input type="text" name="program" id="program" value="{{ old('program', $charge->program) }}" class="mt-1 block w-full px-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="e.g., 16 week 1-1 nutrition coaching">
                @error('program')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="country" id="country" value="{{ old('country', $charge->country) }}" class="mt-1 block w-full px-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="e.g., US">
                @error('country')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="url" name="stripe_url" id="stripe_url" value="{{ old('stripe_url', $charge->stripe_url) }}" class="mt-1 block w-full px-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="https://...">
                @error('stripe_url')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="stripe_transaction_id" id="stripe_transaction_id" value="{{ old('stripe_transaction_id', $charge->stripe_transaction_id) }}" class="mt-1 block w-full px-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="txn_...">
            ...
            <div>
                ...
                <input type="text" name="stripe_charge_id" id="stripe_charge_id" value="{{ old('stripe_charge_id', $charge->stripe_charge_id) }}" class="mt-1 block w-full px-4 py-2.5 rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900" placeholder="ch_...">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center">
                    <input type="checkbox" name="billing_information_included" id="billing_information_included" value="1" {{ old('billing_information_included', $charge->billing_information_included) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">

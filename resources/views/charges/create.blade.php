...
@php
    ...
    $initialClientId = old('client_id') ? (int)old('client_id') : null;
    $initialCoachId = old('coach_id') ? (int)old('coach_id') : null;
@endphp
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('charges.store') }}" method="POST" class="bg-white shadow rounded-lg p-6" x-data="{
